...
echo "<tr><td>3.</td><td>&nbsp;</td><td><font color=green><b>Select Template</b>(Click on the screenshot to see a preview )</font><br></td></td></tr><br>";
	...
	while(!(($design = readdir($template))===false)){
     	...
     	if ($design =='.'){
			...
			echo "<td><center>$design<br><a href=\"samplepage.php?template=$design\" target=new ><img src =\"template/$design/screenshot.jpg\"></a><br><input type=\"radio\" name=\"selectTemplate\" value=\"$design\" $checked ></center>";
			if($count%2==0)
			{
				echo "</td></tr>";
			}else
